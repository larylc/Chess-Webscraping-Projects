...
Summary: The [**More-Chess-Webscraped-Data Repository**](https://github.com/larylc/More-Chess-Webscraped-Data/blob/main/README.md) contains the web scraping projects that used the data from project 2 to extract data from birthplace and birthdate information from Wikipedia and and online database.
